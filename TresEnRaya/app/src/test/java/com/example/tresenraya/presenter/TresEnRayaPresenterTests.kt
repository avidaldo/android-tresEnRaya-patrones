...
class TresEnRayaPresenterTests {
    ...
    /** Función que indica al presenter que se ha hecho click en una celda y
     * verifica que, como resultado,
     * la vista acaba llamando al método setButtonText
     * para esa celda con el valor esperado como texto */
